...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <a href="{{route('backend.location.delete',$data->id)}}"><button type="button" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')">Delete</button></a>
      </td>
    </tr>
  @endforeach
</table>
